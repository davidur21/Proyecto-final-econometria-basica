...
- **datos_encuesta.csv** — versión procesada a partir de `Scripts/codigo-r`: nombres de columna estandarizados, valores faltantes tratados y tipos de dato corregidos. Este es el archivo que alimenta el tablero Shiny.
- **datos_encuesta.xlsx** — misma base de datos limpia, en formato Excel, tal como lo exige la rúbrica del entregable ("Base de datos en Excel y una copia en formato .csv").
